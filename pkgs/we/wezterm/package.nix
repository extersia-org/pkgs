...
rustPlatform.buildRustPackage (finalAttrs: {
  pname = "wezterm";
  version = "20240203-110809-5046fc22-unstable-2026-06-05";

  src = fetchFromGitHub {
    owner = "wezterm";
    repo = "wezterm";
    rev = "dab1816d05e948182f799903e6d6be59699d7629";
    hash = "sha256-Hf6AhFYKDHMjmuJESc7v9mIsBTHVkV9TnBWNrUSzzEM=";
